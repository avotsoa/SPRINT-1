...
<body>
  <div class="container">
    ...
    <div class="info">
      <p><strong>Sprint 8-bis:</strong> Ce formulaire utilise la convention <code>e.name</code> pour passer un objet directement au controleur.</p>
      <p>L'objet <code>Emp</code> sera automatiquement instancie et rempli avec les valeurs du formulaire.</p>
    </div>
    
    <p><%= request.getAttribute("message") %></p>
    
    <form action="/FrameworkResume/emp/save" method="POST">
